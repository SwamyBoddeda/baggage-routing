package com.enterprise.routing.baggagerouting;
...
import com.enterprise.routing.baggagerouting.model.Edge;
import com.enterprise.routing.baggagerouting.model.Graph;
import com.enterprise.routing.baggagerouting.model.Vertex;
    ...
    extends TestCase
{
	...
	private void getPathDistance(Map.Entry<String,Vertex[]> bag) {
		...
		routing.execute(vertexes[0]);
		Map<Integer,LinkedList<Vertex>> path = routing.getPath(vertexes[1]);
